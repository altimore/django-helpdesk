...
class TicketActionsTestCase(TestCase):
    ...
    def test_num_to_link(self):
        ...
        self.assertEqual(
            result,
            "this is ticket <a href='/helpdesk/tickets/%s/' class='ticket_link_status ticket_link_status_Open'>#%s</a>"
            % (ticket_id, ticket_id),
        )
        ...
        self.assertEqual(
            result2,
            "whoa another ticket is here  <a href='/helpdesk/tickets/%s/' class='ticket_link_status ticket_link_status_Open'>#%s</a> huh"
            % (ticket_id, ticket_id),
        )
