...
class Ticket(models.Model):
    ...
    def _get_staff_url(self):
        ...
        try:
            ...
            site = Site(domain="configure-django-sites.com")
        return "http://%s%s" % (site.domain, reverse("helpdesk:view", args=[self.id]))
...
class TicketChange(models.Model):
    ...
    followup = models.ForeignKey(
        FollowUp, on_delete=models.CASCADE, verbose_name=_("Follow-up")
    )
...
class EscalationExclusion(models.Model):
    ...
    date = models.DateField(
        _("Date"), help_text=_("Date on which escalation should not happen")
    )
...
class SavedSearch(models.Model):
    ...
    query = models.TextField(
        _("Search Query"), help_text=_("Pickled query object. Be wary changing this.")
    )
...
class CustomField(models.Model):
    ...
    label = models.CharField(
        _("Label"), max_length=30, help_text=_("The display label for this field")
    )
    ...
    max_length = models.IntegerField(
        _("Maximum Length (characters)"), blank=True, null=True
    )
...
class TicketCustomFieldValue(models.Model):
    ...
    field = models.ForeignKey(
        CustomField, on_delete=models.CASCADE, verbose_name=_("Field")
    )
